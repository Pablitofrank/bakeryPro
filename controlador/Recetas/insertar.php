...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conexion->query($sqlProducto) === TRUE) {
        ...
        // Verificar si los insumos, sus cantidades y unidades de medida fueron proporcionados
        if (isset($_POST['NombreInsumo']) && isset($_POST['cantidadInsumo']) && isset($_POST['idUnidadMedida'])) {
            // Obtener los insumos, sus cantidades y unidades de medida desde el formulario
            ...
            $sqlReceta = "INSERT INTO tblrecetas (CantidadInsumo, IdProducto, IdInsumo, IdUnidadMedida) VALUES ";
            ...
            for ($i = 0; $i < count($nombreInsumos); $i++) {
                ...
                if ($resultCheckInsumo->num_rows > 0) {
                    ...
                    $sqlReceta .= "('$cantidadInsumo', '$idProducto', '$nombreInsumo', '$idUnidadMedida'),";
                } else {
            ...
            // Si no se proporcionaron los insumos, sus cantidades y unidades de medida, mostrar un mensaje de error y terminar la ejecución del script
            echo "Error: no se proporcionaron los insumos, sus cantidades y unidades de medida.";
            exit();
        }
    } else {
